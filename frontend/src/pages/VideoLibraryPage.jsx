    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-900 via-blue-900 to-black">
      ...
      <div className="container mx-auto px-4 py-12 sm:py-20">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 sm:gap-0 mb-8 sm:mb-12">
          <div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2 sm:mb-4">Video Library</h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-300">Manage and view all your AI-generated video projects</p>
          </div>
          <button
            onClick={() => navigate('/create-video')}
            className="px-6 sm:px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition-all transform hover:scale-105 flex items-center justify-center whitespace-nowrap"
          >
